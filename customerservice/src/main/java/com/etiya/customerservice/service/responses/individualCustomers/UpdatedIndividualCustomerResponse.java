...
public class UpdatedIndividualCustomerResponse {
    ...
    public UpdatedIndividualCustomerResponse(UUID id, String firstName, String lastName, String middleName, String nationalId, String dateOfBirth, String motherName, String fatherName, String gender) {
        this.id = id;
        this.firstName = firstName;
        this.lastName = lastName;
        this.middleName = middleName;
