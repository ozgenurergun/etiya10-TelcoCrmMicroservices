...
public class DistrictServiceImpl implements DistrictService {
    ...
    private final DistrictBusinessRules districtBusinessRoles;
    private final CityService cityService;

    public DistrictServiceImpl(DistrictRepository districtRepository, DistrictBusinessRules districtBusinessRoles, CityService cityService) {
