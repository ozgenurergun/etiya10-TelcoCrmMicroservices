...
public class GetListCharacteristicResponse {
    ...
    public GetListCharacteristicResponse() {
    }

    public GetListCharacteristicResponse(int id, String description, String unitOfMeasure, int GENELTYPE_ID) {
        this.id = id;
        this.description = description;
        this.unitOfMeasure = unitOfMeasure;
