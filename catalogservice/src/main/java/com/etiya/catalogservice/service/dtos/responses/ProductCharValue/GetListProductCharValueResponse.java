...
public class GetListProductCharValueResponse {
    ...
    public GetListProductCharValueResponse() {
    }

    public GetListProductCharValueResponse(int id, int charValueId, int productId) {
        this.id = id;
        this.charValueId = charValueId;
        this.productId = productId;
    }
